...
public class RepairServiceImpl implements RepairService
{
    ...
    public void clearBid(Bid acceptedBid)
    {
        ...
        // do not use removeRepair since this also remove bids associated
        // with the repair: this.removeRepair(acceptedBid.getRepairer(), repair);
        acceptedBid.getRepairer().getRepairs().remove(repair);
